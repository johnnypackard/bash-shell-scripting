...
class User:
    ...
    def loadFromInput(self):
        ...
        self.favoriteColor = raw_input('Enter Favorite Color: ')
    ...
    def display(self):
        ...
        print 'User Favorite Color:', self.favoriteColor
